...
// ML307R配置 - ESP32-C3专用引脚
#define ML307R_UART_NUM        UART_NUM_1
#define ML307R_TXD_PIN_C3      4   // ESP32-C3 TX → ML307R RX
#define ML307R_RXD_PIN_C3      5   // ESP32-C3 RX ← ML307R TX
...
typedef struct {
    ...
    char ip_address[16];
    bool is_esp32c3;  // C3标识符
} ml307r_t;

/**
 * @brief 初始化ML307R模块 - ESP32-C3版本
 * 
