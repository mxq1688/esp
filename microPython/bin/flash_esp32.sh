...
# ESP32 经典款 MicroPython 固件烧录脚本
# 使用方法: ./flash_esp32.sh [端口号]
# 例如: ./flash_esp32.sh /dev/tty.usbserial-0001
...
echo -e "${BLUE}=== ESP32 经典款 MicroPython 固件烧录工具 ===${NC}"
echo
...
read -p "确认要烧录 ESP32 经典款固件吗? (y/N): " confirm
...
echo
echo -e "${GREEN}🎉 ESP32 经典款固件烧录成功!${NC}"
echo
echo -e "${BLUE}📋 后续步骤:${NC}"
